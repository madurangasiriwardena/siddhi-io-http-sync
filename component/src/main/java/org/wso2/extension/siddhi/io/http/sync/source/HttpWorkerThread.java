...
import org.wso2.extension.siddhi.io.http.sync.source.util.HttpSourceUtil;
...
public class HttpWorkerThread implements Runnable {
    ...
    HttpWorkerThread(HTTPCarbonMessage cMessage, SourceEventListener sourceEventListener,
                     String sourceID, String[] trpProperties, String messageId) {
    ...
    public void run() {
        ...
        try {
            ...
            if (!payload.equals(HttpConstants.EMPTY_STRING)) {
                ResultHandler.registerCallback(carbonMessage, messageId);
